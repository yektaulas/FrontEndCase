...
export default function ExportShareIcon({
  circleExportAndShareRef,
  currentPath,
}: {
  circleExportAndShareRef: RefObject<SVGCircleElement>;
  currentPath: string;
}) {
  return (
    <>
      ...
      >
        ...
        <circle
          ...
          strokeWidth="2"
          style={{
            strokeDashoffset: currentPath === '/export_share' ? 0 : 180,
          }}
          className={`hover-circle ${
            currentPath === '/export_share' ? 'animate-drawCircleSpinnerIn' : ''
          }`}
        ></circle>
      </svg>
      <svg
